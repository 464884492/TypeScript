...
function buildUniqueNameMap(names: string[]): ts.StringMap<string> {
...
function buildInfoFileOutput(messageTable: InputDiagnosticMessageTable, nameMap: ts.StringMap<string>): string {
    var result =
        '// <auto-generated />\r\n' +
...
function buildDiagnosticMessageOutput(messageTable: InputDiagnosticMessageTable, nameMap: ts.StringMap<string>): string {
    var result =
        '{';
    var names = Utilities.getObjectKeys(messageTable);
    for (var i = 0; i < names.length; i++) {
